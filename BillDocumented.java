    ...
    public String getUrlInfo(){
        ...
        //"ERROR: API CALL TO HPMS BILLING FAILED" and an exit code of 1.
               ...
               //Catch statement that runs if there is a failure with the API Call.
                   ...
                   //Message printed to the error stream, "ERROR: API CALL TO HPMS BILLING FAILED"
                   System.err.println("ERROR: API CALL TO HPMS BILLING FAILED");
                   //System exits with exit code 1.
                   System.exit(1);
                   }
